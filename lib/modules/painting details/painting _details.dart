...
class PaintingDetails extends StatefulWidget {
  ...
  const PaintingDetails({required this.paintingId, super.key});
                ...
                children: [
                  Positioned(
                    ...
                    child: CachedNetworkImage(
                      ...
                      imageUrl: _controller.paintingsModel!.painting!.url ?? "",
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        Positioned(
                                          ...
                                          left: 60,
                                          child: Text(
                                            '${_controller.paintingsModel!.painting!.creationDate}',
                                            style: TextStyle(
                                              color: Colors.black87,
                                              fontSize: 8,
                                              fontWeight: FontWeight.normal,
                                ...
                                Text(
                                  ' ${_controller.paintingsModel!.painting!.type}',
                                  style: TextStyle(
                                    color: Colors.black87,
                                    fontStyle: FontStyle.italic,
                                  ),
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: Center(
                                      child: Container(
                                        ...
                                        child: Text(
                                          ' ${_controller.imageDescription.value}',
                                          style: TextStyle(
                                            color: Colors.black87,
                                            fontStyle: FontStyle.italic,
                                          ),
                                  ...
                                  children: [
                                    ...
                                    RatingBar.builder(
                                      ...
                                      onRatingUpdate: (newRating) {
                                        setState(() {
                                          rating =
                                              newRating; // تحديث التقييم عند تغييره
                                        });
