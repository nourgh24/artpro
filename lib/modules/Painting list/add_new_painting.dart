...
final PaintingTypeController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor:painting == null?Colors.orange[300] :Colors.orange[200],
        leading:
        TextButton(onPressed: (){
          Get.back();
        },child: Text('Cancel',style: TextStyle(fontSize: 15,color: Colors.white),),),
        title: Center(
          child: Text(painting == null ? 'Add Painting'  : 'Edit Painting',
        ...
        size: 40,
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (index == null) {
                imageController.addPainting(newPainting);
              } else {
                imageController.updatePainting(index!, newPainting);
              }
              Get.back();
            },
            child: Text(painting== null ? 'Add' : 'Update',
            style: TextStyle(color: Colors.white),
            ),
